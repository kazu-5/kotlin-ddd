...
public class OptimizerTraceRecord extends TableRecordImpl<OptimizerTraceRecord> implements Record4<String, String, Integer, Byte> {
    ...
    private static final long serialVersionUID = 1248424994;
    ...
    public Field<String> field1() {
        return OPTIMIZER_TRACE_TABLE.OPTIMIZER_TRACE.QUERY;
    }

    @Override
    public Field<String> field2() {
        return OPTIMIZER_TRACE_TABLE.OPTIMIZER_TRACE.TRACE;
    }

    @Override
    public Field<Integer> field3() {
        return OPTIMIZER_TRACE_TABLE.OPTIMIZER_TRACE.MISSING_BYTES_BEYOND_MAX_MEM_SIZE;
    }

    @Override
    public Field<Byte> field4() {
        return OPTIMIZER_TRACE_TABLE.OPTIMIZER_TRACE.INSUFFICIENT_PRIVILEGES;
    }
    ...
    public OptimizerTraceRecord() {
        super(OPTIMIZER_TRACE_TABLE.OPTIMIZER_TRACE);
    }
