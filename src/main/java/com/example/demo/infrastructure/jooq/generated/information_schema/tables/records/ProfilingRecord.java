...
public class ProfilingRecord extends TableRecordImpl<ProfilingRecord> implements Record18<Integer, Integer, String, BigDecimal, BigDecimal, BigDecimal, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, String, String, Integer> {
    ...
    private static final long serialVersionUID = 386324157;
    ...
    public Field<Integer> field1() {
        return PROFILING_TABLE.PROFILING.QUERY_ID;
    }

    @Override
    public Field<Integer> field2() {
        return PROFILING_TABLE.PROFILING.SEQ;
    }

    @Override
    public Field<String> field3() {
        return PROFILING_TABLE.PROFILING.STATE;
    }

    @Override
    public Field<BigDecimal> field4() {
        return PROFILING_TABLE.PROFILING.DURATION;
    }

    @Override
    public Field<BigDecimal> field5() {
        return PROFILING_TABLE.PROFILING.CPU_USER;
    }

    @Override
    public Field<BigDecimal> field6() {
        return PROFILING_TABLE.PROFILING.CPU_SYSTEM;
    }

    @Override
    public Field<Integer> field7() {
        return PROFILING_TABLE.PROFILING.CONTEXT_VOLUNTARY;
    }

    @Override
    public Field<Integer> field8() {
        return PROFILING_TABLE.PROFILING.CONTEXT_INVOLUNTARY;
    }

    @Override
    public Field<Integer> field9() {
        return PROFILING_TABLE.PROFILING.BLOCK_OPS_IN;
    }

    @Override
    public Field<Integer> field10() {
        return PROFILING_TABLE.PROFILING.BLOCK_OPS_OUT;
    }

    @Override
    public Field<Integer> field11() {
        return PROFILING_TABLE.PROFILING.MESSAGES_SENT;
    }

    @Override
    public Field<Integer> field12() {
        return PROFILING_TABLE.PROFILING.MESSAGES_RECEIVED;
    }

    @Override
    public Field<Integer> field13() {
        return PROFILING_TABLE.PROFILING.PAGE_FAULTS_MAJOR;
    }

    @Override
    public Field<Integer> field14() {
        return PROFILING_TABLE.PROFILING.PAGE_FAULTS_MINOR;
    }

    @Override
    public Field<Integer> field15() {
        return PROFILING_TABLE.PROFILING.SWAPS;
    }

    @Override
    public Field<String> field16() {
        return PROFILING_TABLE.PROFILING.SOURCE_FUNCTION;
    }

    @Override
    public Field<String> field17() {
        return PROFILING_TABLE.PROFILING.SOURCE_FILE;
    }

    @Override
    public Field<Integer> field18() {
        return PROFILING_TABLE.PROFILING.SOURCE_LINE;
    }
    ...
    public ProfilingRecord() {
        super(PROFILING_TABLE.PROFILING);
    }
