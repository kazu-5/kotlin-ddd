...
public class X$waitClassesGlobalByLatencyRecord extends TableRecordImpl<X$waitClassesGlobalByLatencyRecord> implements Record6<String, BigInteger, BigInteger, ULong, BigDecimal, ULong> {
    ...
    private static final long serialVersionUID = -185568810;
    ...
    public Field<String> field1() {
        return X$WAIT_CLASSES_GLOBAL_BY_LATENCY_TABLE.X$WAIT_CLASSES_GLOBAL_BY_LATENCY.EVENT_CLASS;
    }

    @Override
    public Field<BigInteger> field2() {
        return X$WAIT_CLASSES_GLOBAL_BY_LATENCY_TABLE.X$WAIT_CLASSES_GLOBAL_BY_LATENCY.TOTAL;
    }

    @Override
    public Field<BigInteger> field3() {
        return X$WAIT_CLASSES_GLOBAL_BY_LATENCY_TABLE.X$WAIT_CLASSES_GLOBAL_BY_LATENCY.TOTAL_LATENCY;
    }

    @Override
    public Field<ULong> field4() {
        return X$WAIT_CLASSES_GLOBAL_BY_LATENCY_TABLE.X$WAIT_CLASSES_GLOBAL_BY_LATENCY.MIN_LATENCY;
    }

    @Override
    public Field<BigDecimal> field5() {
        return X$WAIT_CLASSES_GLOBAL_BY_LATENCY_TABLE.X$WAIT_CLASSES_GLOBAL_BY_LATENCY.AVG_LATENCY;
    }

    @Override
    public Field<ULong> field6() {
        return X$WAIT_CLASSES_GLOBAL_BY_LATENCY_TABLE.X$WAIT_CLASSES_GLOBAL_BY_LATENCY.MAX_LATENCY;
    }
    ...
    public X$waitClassesGlobalByLatencyRecord() {
        super(X$WAIT_CLASSES_GLOBAL_BY_LATENCY_TABLE.X$WAIT_CLASSES_GLOBAL_BY_LATENCY);
    }
