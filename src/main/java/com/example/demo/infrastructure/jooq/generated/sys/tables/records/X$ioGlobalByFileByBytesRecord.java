...
public class X$ioGlobalByFileByBytesRecord extends TableRecordImpl<X$ioGlobalByFileByBytesRecord> implements Record9<String, ULong, Long, BigDecimal, ULong, Long, BigDecimal, Long, BigDecimal> {
    ...
    private static final long serialVersionUID = 2115791923;
    ...
    public Field<String> field1() {
        return X$IO_GLOBAL_BY_FILE_BY_BYTES_TABLE.X$IO_GLOBAL_BY_FILE_BY_BYTES.FILE;
    }

    @Override
    public Field<ULong> field2() {
        return X$IO_GLOBAL_BY_FILE_BY_BYTES_TABLE.X$IO_GLOBAL_BY_FILE_BY_BYTES.COUNT_READ;
    }

    @Override
    public Field<Long> field3() {
        return X$IO_GLOBAL_BY_FILE_BY_BYTES_TABLE.X$IO_GLOBAL_BY_FILE_BY_BYTES.TOTAL_READ;
    }

    @Override
    public Field<BigDecimal> field4() {
        return X$IO_GLOBAL_BY_FILE_BY_BYTES_TABLE.X$IO_GLOBAL_BY_FILE_BY_BYTES.AVG_READ;
    }

    @Override
    public Field<ULong> field5() {
        return X$IO_GLOBAL_BY_FILE_BY_BYTES_TABLE.X$IO_GLOBAL_BY_FILE_BY_BYTES.COUNT_WRITE;
    }

    @Override
    public Field<Long> field6() {
        return X$IO_GLOBAL_BY_FILE_BY_BYTES_TABLE.X$IO_GLOBAL_BY_FILE_BY_BYTES.TOTAL_WRITTEN;
    }

    @Override
    public Field<BigDecimal> field7() {
        return X$IO_GLOBAL_BY_FILE_BY_BYTES_TABLE.X$IO_GLOBAL_BY_FILE_BY_BYTES.AVG_WRITE;
    }

    @Override
    public Field<Long> field8() {
        return X$IO_GLOBAL_BY_FILE_BY_BYTES_TABLE.X$IO_GLOBAL_BY_FILE_BY_BYTES.TOTAL;
    }

    @Override
    public Field<BigDecimal> field9() {
        return X$IO_GLOBAL_BY_FILE_BY_BYTES_TABLE.X$IO_GLOBAL_BY_FILE_BY_BYTES.WRITE_PCT;
    }
    ...
    public X$ioGlobalByFileByBytesRecord() {
        super(X$IO_GLOBAL_BY_FILE_BY_BYTES_TABLE.X$IO_GLOBAL_BY_FILE_BY_BYTES);
    }
