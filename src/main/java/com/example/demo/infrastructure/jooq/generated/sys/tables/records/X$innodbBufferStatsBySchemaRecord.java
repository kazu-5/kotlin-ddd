...
public class X$innodbBufferStatsBySchemaRecord extends TableRecordImpl<X$innodbBufferStatsBySchemaRecord> implements Record7<String, BigInteger, BigInteger, Long, Long, Long, BigInteger> {
    ...
    private static final long serialVersionUID = 1147906322;
    ...
    public Field<String> field1() {
        return X$INNODB_BUFFER_STATS_BY_SCHEMA_TABLE.X$INNODB_BUFFER_STATS_BY_SCHEMA.OBJECT_SCHEMA;
    }

    @Override
    public Field<BigInteger> field2() {
        return X$INNODB_BUFFER_STATS_BY_SCHEMA_TABLE.X$INNODB_BUFFER_STATS_BY_SCHEMA.ALLOCATED;
    }

    @Override
    public Field<BigInteger> field3() {
        return X$INNODB_BUFFER_STATS_BY_SCHEMA_TABLE.X$INNODB_BUFFER_STATS_BY_SCHEMA.DATA;
    }

    @Override
    public Field<Long> field4() {
        return X$INNODB_BUFFER_STATS_BY_SCHEMA_TABLE.X$INNODB_BUFFER_STATS_BY_SCHEMA.PAGES;
    }

    @Override
    public Field<Long> field5() {
        return X$INNODB_BUFFER_STATS_BY_SCHEMA_TABLE.X$INNODB_BUFFER_STATS_BY_SCHEMA.PAGES_HASHED;
    }

    @Override
    public Field<Long> field6() {
        return X$INNODB_BUFFER_STATS_BY_SCHEMA_TABLE.X$INNODB_BUFFER_STATS_BY_SCHEMA.PAGES_OLD;
    }

    @Override
    public Field<BigInteger> field7() {
        return X$INNODB_BUFFER_STATS_BY_SCHEMA_TABLE.X$INNODB_BUFFER_STATS_BY_SCHEMA.ROWS_CACHED;
    }
    ...
    public X$innodbBufferStatsBySchemaRecord() {
        super(X$INNODB_BUFFER_STATS_BY_SCHEMA_TABLE.X$INNODB_BUFFER_STATS_BY_SCHEMA);
    }
