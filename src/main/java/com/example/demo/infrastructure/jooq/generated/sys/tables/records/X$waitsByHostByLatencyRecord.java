...
public class X$waitsByHostByLatencyRecord extends TableRecordImpl<X$waitsByHostByLatencyRecord> implements Record6<String, String, ULong, ULong, ULong, ULong> {
    ...
    private static final long serialVersionUID = 69930995;
    ...
    public Field<String> field1() {
        return X$WAITS_BY_HOST_BY_LATENCY_TABLE.X$WAITS_BY_HOST_BY_LATENCY.HOST;
    }

    @Override
    public Field<String> field2() {
        return X$WAITS_BY_HOST_BY_LATENCY_TABLE.X$WAITS_BY_HOST_BY_LATENCY.EVENT;
    }

    @Override
    public Field<ULong> field3() {
        return X$WAITS_BY_HOST_BY_LATENCY_TABLE.X$WAITS_BY_HOST_BY_LATENCY.TOTAL;
    }

    @Override
    public Field<ULong> field4() {
        return X$WAITS_BY_HOST_BY_LATENCY_TABLE.X$WAITS_BY_HOST_BY_LATENCY.TOTAL_LATENCY;
    }

    @Override
    public Field<ULong> field5() {
        return X$WAITS_BY_HOST_BY_LATENCY_TABLE.X$WAITS_BY_HOST_BY_LATENCY.AVG_LATENCY;
    }

    @Override
    public Field<ULong> field6() {
        return X$WAITS_BY_HOST_BY_LATENCY_TABLE.X$WAITS_BY_HOST_BY_LATENCY.MAX_LATENCY;
    }
    ...
    public X$waitsByHostByLatencyRecord() {
        super(X$WAITS_BY_HOST_BY_LATENCY_TABLE.X$WAITS_BY_HOST_BY_LATENCY);
    }
