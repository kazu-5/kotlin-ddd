...
import com.example.demo.infrastructure.jooq.generated.information_schema.tables.records.InnodbBufferPoolStatsRecord;
...
public class INNODB_BUFFER_POOL_STATS_TABLE extends TableImpl<InnodbBufferPoolStatsRecord> {

    private static final long serialVersionUID = 151321017;

    /**
     * The reference instance of <code>information_schema.INNODB_BUFFER_POOL_STATS</code>
     */
    public static final INNODB_BUFFER_POOL_STATS_TABLE INNODB_BUFFER_POOL_STATS = new INNODB_BUFFER_POOL_STATS_TABLE();
     ...
     */
    public INNODB_BUFFER_POOL_STATS_TABLE() {
     ...
     */
    public INNODB_BUFFER_POOL_STATS_TABLE(String alias) {
     ...
     * Create an aliased <code>information_schema.INNODB_BUFFER_POOL_STATS</code> table reference
     */
    public INNODB_BUFFER_POOL_STATS_TABLE(Name alias) {
        this(alias, INNODB_BUFFER_POOL_STATS);
    }

    private INNODB_BUFFER_POOL_STATS_TABLE(Name alias, Table<InnodbBufferPoolStatsRecord> aliased) {
        this(alias, aliased, null);
    }

    private INNODB_BUFFER_POOL_STATS_TABLE(Name alias, Table<InnodbBufferPoolStatsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""));
    }

    public <O extends Record> INNODB_BUFFER_POOL_STATS_TABLE(Table<O> child, ForeignKey<O, InnodbBufferPoolStatsRecord> key) {
    ...
    @Override
    public INNODB_BUFFER_POOL_STATS_TABLE as(String alias) {
        return new INNODB_BUFFER_POOL_STATS_TABLE(DSL.name(alias), this);
    }

    @Override
    public INNODB_BUFFER_POOL_STATS_TABLE as(Name alias) {
        return new INNODB_BUFFER_POOL_STATS_TABLE(alias, this);
    }
     ...
     */
    @Override
    public INNODB_BUFFER_POOL_STATS_TABLE rename(String name) {
        return new INNODB_BUFFER_POOL_STATS_TABLE(DSL.name(name), null);
    }
     ...
     */
    @Override
    public INNODB_BUFFER_POOL_STATS_TABLE rename(Name name) {
        return new INNODB_BUFFER_POOL_STATS_TABLE(name, null);
    }
}
