...
public class HostSummaryByFileIoRecord extends TableRecordImpl<HostSummaryByFileIoRecord> implements Record3<String, BigInteger, String> {
    ...
    private static final long serialVersionUID = 1695061213;
    ...
    public Field<String> field1() {
        return HOST_SUMMARY_BY_FILE_IO_TABLE.HOST_SUMMARY_BY_FILE_IO.HOST;
    }

    @Override
    public Field<BigInteger> field2() {
        return HOST_SUMMARY_BY_FILE_IO_TABLE.HOST_SUMMARY_BY_FILE_IO.IOS;
    }

    @Override
    public Field<String> field3() {
        return HOST_SUMMARY_BY_FILE_IO_TABLE.HOST_SUMMARY_BY_FILE_IO.IO_LATENCY;
    }
    ...
    public HostSummaryByFileIoRecord() {
        super(HOST_SUMMARY_BY_FILE_IO_TABLE.HOST_SUMMARY_BY_FILE_IO);
    }
