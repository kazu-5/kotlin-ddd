...
public class ObjectsSummaryGlobalByTypeRecord extends TableRecordImpl<ObjectsSummaryGlobalByTypeRecord> implements Record8<String, String, String, ULong, ULong, ULong, ULong, ULong> {
    ...
    private static final long serialVersionUID = -44691250;
    ...
    public Field<String> field1() {
        return OBJECTS_SUMMARY_GLOBAL_BY_TYPE_TABLE.OBJECTS_SUMMARY_GLOBAL_BY_TYPE.OBJECT_TYPE;
    }

    @Override
    public Field<String> field2() {
        return OBJECTS_SUMMARY_GLOBAL_BY_TYPE_TABLE.OBJECTS_SUMMARY_GLOBAL_BY_TYPE.OBJECT_SCHEMA;
    }

    @Override
    public Field<String> field3() {
        return OBJECTS_SUMMARY_GLOBAL_BY_TYPE_TABLE.OBJECTS_SUMMARY_GLOBAL_BY_TYPE.OBJECT_NAME;
    }

    @Override
    public Field<ULong> field4() {
        return OBJECTS_SUMMARY_GLOBAL_BY_TYPE_TABLE.OBJECTS_SUMMARY_GLOBAL_BY_TYPE.COUNT_STAR;
    }

    @Override
    public Field<ULong> field5() {
        return OBJECTS_SUMMARY_GLOBAL_BY_TYPE_TABLE.OBJECTS_SUMMARY_GLOBAL_BY_TYPE.SUM_TIMER_WAIT;
    }

    @Override
    public Field<ULong> field6() {
        return OBJECTS_SUMMARY_GLOBAL_BY_TYPE_TABLE.OBJECTS_SUMMARY_GLOBAL_BY_TYPE.MIN_TIMER_WAIT;
    }

    @Override
    public Field<ULong> field7() {
        return OBJECTS_SUMMARY_GLOBAL_BY_TYPE_TABLE.OBJECTS_SUMMARY_GLOBAL_BY_TYPE.AVG_TIMER_WAIT;
    }

    @Override
    public Field<ULong> field8() {
        return OBJECTS_SUMMARY_GLOBAL_BY_TYPE_TABLE.OBJECTS_SUMMARY_GLOBAL_BY_TYPE.MAX_TIMER_WAIT;
    }
    ...
    public ObjectsSummaryGlobalByTypeRecord() {
        super(OBJECTS_SUMMARY_GLOBAL_BY_TYPE_TABLE.OBJECTS_SUMMARY_GLOBAL_BY_TYPE);
    }
