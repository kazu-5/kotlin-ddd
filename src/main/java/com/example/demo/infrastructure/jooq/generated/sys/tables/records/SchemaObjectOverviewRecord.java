...
public class SchemaObjectOverviewRecord extends TableRecordImpl<SchemaObjectOverviewRecord> implements Record3<String, String, Long> {
    ...
    private static final long serialVersionUID = -1462564193;
    ...
    public Field<String> field1() {
        return SCHEMA_OBJECT_OVERVIEW_TABLE.SCHEMA_OBJECT_OVERVIEW.DB;
    }

    @Override
    public Field<String> field2() {
        return SCHEMA_OBJECT_OVERVIEW_TABLE.SCHEMA_OBJECT_OVERVIEW.OBJECT_TYPE;
    }

    @Override
    public Field<Long> field3() {
        return SCHEMA_OBJECT_OVERVIEW_TABLE.SCHEMA_OBJECT_OVERVIEW.COUNT;
    }
    ...
    public SchemaObjectOverviewRecord() {
        super(SCHEMA_OBJECT_OVERVIEW_TABLE.SCHEMA_OBJECT_OVERVIEW);
    }
