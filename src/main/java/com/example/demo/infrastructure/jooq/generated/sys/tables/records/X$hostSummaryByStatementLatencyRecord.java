...
public class X$hostSummaryByStatementLatencyRecord extends TableRecordImpl<X$hostSummaryByStatementLatencyRecord> implements Record9<String, BigInteger, BigInteger, ULong, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger> {
    ...
    private static final long serialVersionUID = 134730091;
    ...
    public Field<String> field1() {
        return X$HOST_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$HOST_SUMMARY_BY_STATEMENT_LATENCY.HOST;
    }

    @Override
    public Field<BigInteger> field2() {
        return X$HOST_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$HOST_SUMMARY_BY_STATEMENT_LATENCY.TOTAL;
    }

    @Override
    public Field<BigInteger> field3() {
        return X$HOST_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$HOST_SUMMARY_BY_STATEMENT_LATENCY.TOTAL_LATENCY;
    }

    @Override
    public Field<ULong> field4() {
        return X$HOST_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$HOST_SUMMARY_BY_STATEMENT_LATENCY.MAX_LATENCY;
    }

    @Override
    public Field<BigInteger> field5() {
        return X$HOST_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$HOST_SUMMARY_BY_STATEMENT_LATENCY.LOCK_LATENCY;
    }

    @Override
    public Field<BigInteger> field6() {
        return X$HOST_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$HOST_SUMMARY_BY_STATEMENT_LATENCY.ROWS_SENT;
    }

    @Override
    public Field<BigInteger> field7() {
        return X$HOST_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$HOST_SUMMARY_BY_STATEMENT_LATENCY.ROWS_EXAMINED;
    }

    @Override
    public Field<BigInteger> field8() {
        return X$HOST_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$HOST_SUMMARY_BY_STATEMENT_LATENCY.ROWS_AFFECTED;
    }

    @Override
    public Field<BigInteger> field9() {
        return X$HOST_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$HOST_SUMMARY_BY_STATEMENT_LATENCY.FULL_SCANS;
    }
    ...
    public X$hostSummaryByStatementLatencyRecord() {
        super(X$HOST_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$HOST_SUMMARY_BY_STATEMENT_LATENCY);
    }
