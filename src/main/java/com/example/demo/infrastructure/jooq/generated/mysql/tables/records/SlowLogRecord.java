...
public class SlowLogRecord extends TableRecordImpl<SlowLogRecord> implements Record12<Timestamp, String, Time, Time, Integer, Integer, String, Integer, Integer, UInteger, byte[], ULong> {
    ...
    private static final long serialVersionUID = -1022568344;
    ...
    public Field<Timestamp> field1() {
        return SLOW_LOG_TABLE.SLOW_LOG.START_TIME;
    }

    @Override
    public Field<String> field2() {
        return SLOW_LOG_TABLE.SLOW_LOG.USER_HOST;
    }

    @Override
    public Field<Time> field3() {
        return SLOW_LOG_TABLE.SLOW_LOG.QUERY_TIME;
    }

    @Override
    public Field<Time> field4() {
        return SLOW_LOG_TABLE.SLOW_LOG.LOCK_TIME;
    }

    @Override
    public Field<Integer> field5() {
        return SLOW_LOG_TABLE.SLOW_LOG.ROWS_SENT;
    }

    @Override
    public Field<Integer> field6() {
        return SLOW_LOG_TABLE.SLOW_LOG.ROWS_EXAMINED;
    }

    @Override
    public Field<String> field7() {
        return SLOW_LOG_TABLE.SLOW_LOG.DB;
    }

    @Override
    public Field<Integer> field8() {
        return SLOW_LOG_TABLE.SLOW_LOG.LAST_INSERT_ID;
    }

    @Override
    public Field<Integer> field9() {
        return SLOW_LOG_TABLE.SLOW_LOG.INSERT_ID;
    }

    @Override
    public Field<UInteger> field10() {
        return SLOW_LOG_TABLE.SLOW_LOG.SERVER_ID;
    }

    @Override
    public Field<byte[]> field11() {
        return SLOW_LOG_TABLE.SLOW_LOG.SQL_TEXT;
    }

    @Override
    public Field<ULong> field12() {
        return SLOW_LOG_TABLE.SLOW_LOG.THREAD_ID;
    }
