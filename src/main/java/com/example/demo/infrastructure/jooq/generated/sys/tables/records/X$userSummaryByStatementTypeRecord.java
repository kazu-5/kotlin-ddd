...
public class X$userSummaryByStatementTypeRecord extends TableRecordImpl<X$userSummaryByStatementTypeRecord> implements Record10<String, String, ULong, ULong, ULong, ULong, ULong, ULong, ULong, ULong> {
    ...
    private static final long serialVersionUID = -1139754850;
    ...
    public Field<String> field1() {
        return X$USER_SUMMARY_BY_STATEMENT_TYPE_TABLE.X$USER_SUMMARY_BY_STATEMENT_TYPE.USER;
    }

    @Override
    public Field<String> field2() {
        return X$USER_SUMMARY_BY_STATEMENT_TYPE_TABLE.X$USER_SUMMARY_BY_STATEMENT_TYPE.STATEMENT;
    }

    @Override
    public Field<ULong> field3() {
        return X$USER_SUMMARY_BY_STATEMENT_TYPE_TABLE.X$USER_SUMMARY_BY_STATEMENT_TYPE.TOTAL;
    }

    @Override
    public Field<ULong> field4() {
        return X$USER_SUMMARY_BY_STATEMENT_TYPE_TABLE.X$USER_SUMMARY_BY_STATEMENT_TYPE.TOTAL_LATENCY;
    }

    @Override
    public Field<ULong> field5() {
        return X$USER_SUMMARY_BY_STATEMENT_TYPE_TABLE.X$USER_SUMMARY_BY_STATEMENT_TYPE.MAX_LATENCY;
    }

    @Override
    public Field<ULong> field6() {
        return X$USER_SUMMARY_BY_STATEMENT_TYPE_TABLE.X$USER_SUMMARY_BY_STATEMENT_TYPE.LOCK_LATENCY;
    }

    @Override
    public Field<ULong> field7() {
        return X$USER_SUMMARY_BY_STATEMENT_TYPE_TABLE.X$USER_SUMMARY_BY_STATEMENT_TYPE.ROWS_SENT;
    }

    @Override
    public Field<ULong> field8() {
        return X$USER_SUMMARY_BY_STATEMENT_TYPE_TABLE.X$USER_SUMMARY_BY_STATEMENT_TYPE.ROWS_EXAMINED;
    }

    @Override
    public Field<ULong> field9() {
        return X$USER_SUMMARY_BY_STATEMENT_TYPE_TABLE.X$USER_SUMMARY_BY_STATEMENT_TYPE.ROWS_AFFECTED;
    }

    @Override
    public Field<ULong> field10() {
        return X$USER_SUMMARY_BY_STATEMENT_TYPE_TABLE.X$USER_SUMMARY_BY_STATEMENT_TYPE.FULL_SCANS;
    }
    ...
    public X$userSummaryByStatementTypeRecord() {
        super(X$USER_SUMMARY_BY_STATEMENT_TYPE_TABLE.X$USER_SUMMARY_BY_STATEMENT_TYPE);
    }
