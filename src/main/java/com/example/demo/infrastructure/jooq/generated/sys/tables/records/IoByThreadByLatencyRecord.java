...
public class IoByThreadByLatencyRecord extends TableRecordImpl<IoByThreadByLatencyRecord> implements Record8<String, BigInteger, String, String, String, String, ULong, ULong> {
    ...
    private static final long serialVersionUID = 927110086;
    ...
    public Field<String> field1() {
        return IO_BY_THREAD_BY_LATENCY_TABLE.IO_BY_THREAD_BY_LATENCY.USER;
    }

    @Override
    public Field<BigInteger> field2() {
        return IO_BY_THREAD_BY_LATENCY_TABLE.IO_BY_THREAD_BY_LATENCY.TOTAL;
    }

    @Override
    public Field<String> field3() {
        return IO_BY_THREAD_BY_LATENCY_TABLE.IO_BY_THREAD_BY_LATENCY.TOTAL_LATENCY;
    }

    @Override
    public Field<String> field4() {
        return IO_BY_THREAD_BY_LATENCY_TABLE.IO_BY_THREAD_BY_LATENCY.MIN_LATENCY;
    }

    @Override
    public Field<String> field5() {
        return IO_BY_THREAD_BY_LATENCY_TABLE.IO_BY_THREAD_BY_LATENCY.AVG_LATENCY;
    }

    @Override
    public Field<String> field6() {
        return IO_BY_THREAD_BY_LATENCY_TABLE.IO_BY_THREAD_BY_LATENCY.MAX_LATENCY;
    }

    @Override
    public Field<ULong> field7() {
        return IO_BY_THREAD_BY_LATENCY_TABLE.IO_BY_THREAD_BY_LATENCY.THREAD_ID;
    }

    @Override
    public Field<ULong> field8() {
        return IO_BY_THREAD_BY_LATENCY_TABLE.IO_BY_THREAD_BY_LATENCY.PROCESSLIST_ID;
    }
    ...
    public IoByThreadByLatencyRecord() {
        super(IO_BY_THREAD_BY_LATENCY_TABLE.IO_BY_THREAD_BY_LATENCY);
    }
