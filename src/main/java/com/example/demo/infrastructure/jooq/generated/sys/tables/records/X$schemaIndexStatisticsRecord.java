...
public class X$schemaIndexStatisticsRecord extends TableRecordImpl<X$schemaIndexStatisticsRecord> implements Record11<String, String, String, ULong, ULong, ULong, ULong, ULong, ULong, ULong, ULong> {
    ...
    private static final long serialVersionUID = -574366596;
    ...
    public Field<String> field1() {
        return X$SCHEMA_INDEX_STATISTICS_TABLE.X$SCHEMA_INDEX_STATISTICS.TABLE_SCHEMA;
    }

    @Override
    public Field<String> field2() {
        return X$SCHEMA_INDEX_STATISTICS_TABLE.X$SCHEMA_INDEX_STATISTICS.TABLE_NAME;
    }

    @Override
    public Field<String> field3() {
        return X$SCHEMA_INDEX_STATISTICS_TABLE.X$SCHEMA_INDEX_STATISTICS.INDEX_NAME;
    }

    @Override
    public Field<ULong> field4() {
        return X$SCHEMA_INDEX_STATISTICS_TABLE.X$SCHEMA_INDEX_STATISTICS.ROWS_SELECTED;
    }

    @Override
    public Field<ULong> field5() {
        return X$SCHEMA_INDEX_STATISTICS_TABLE.X$SCHEMA_INDEX_STATISTICS.SELECT_LATENCY;
    }

    @Override
    public Field<ULong> field6() {
        return X$SCHEMA_INDEX_STATISTICS_TABLE.X$SCHEMA_INDEX_STATISTICS.ROWS_INSERTED;
    }

    @Override
    public Field<ULong> field7() {
        return X$SCHEMA_INDEX_STATISTICS_TABLE.X$SCHEMA_INDEX_STATISTICS.INSERT_LATENCY;
    }

    @Override
    public Field<ULong> field8() {
        return X$SCHEMA_INDEX_STATISTICS_TABLE.X$SCHEMA_INDEX_STATISTICS.ROWS_UPDATED;
    }

    @Override
    public Field<ULong> field9() {
        return X$SCHEMA_INDEX_STATISTICS_TABLE.X$SCHEMA_INDEX_STATISTICS.UPDATE_LATENCY;
    }

    @Override
    public Field<ULong> field10() {
        return X$SCHEMA_INDEX_STATISTICS_TABLE.X$SCHEMA_INDEX_STATISTICS.ROWS_DELETED;
    }

    @Override
    public Field<ULong> field11() {
        return X$SCHEMA_INDEX_STATISTICS_TABLE.X$SCHEMA_INDEX_STATISTICS.DELETE_LATENCY;
    }
    ...
    public X$schemaIndexStatisticsRecord() {
        super(X$SCHEMA_INDEX_STATISTICS_TABLE.X$SCHEMA_INDEX_STATISTICS);
    }
