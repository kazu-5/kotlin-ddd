...
public class X$userSummaryByStatementLatencyRecord extends TableRecordImpl<X$userSummaryByStatementLatencyRecord> implements Record9<String, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger> {
    ...
    private static final long serialVersionUID = -1776252333;
    ...
    public Field<String> field1() {
        return X$USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$USER_SUMMARY_BY_STATEMENT_LATENCY.USER;
    }

    @Override
    public Field<BigInteger> field2() {
        return X$USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$USER_SUMMARY_BY_STATEMENT_LATENCY.TOTAL;
    }

    @Override
    public Field<BigInteger> field3() {
        return X$USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$USER_SUMMARY_BY_STATEMENT_LATENCY.TOTAL_LATENCY;
    }

    @Override
    public Field<BigInteger> field4() {
        return X$USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$USER_SUMMARY_BY_STATEMENT_LATENCY.MAX_LATENCY;
    }

    @Override
    public Field<BigInteger> field5() {
        return X$USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$USER_SUMMARY_BY_STATEMENT_LATENCY.LOCK_LATENCY;
    }

    @Override
    public Field<BigInteger> field6() {
        return X$USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$USER_SUMMARY_BY_STATEMENT_LATENCY.ROWS_SENT;
    }

    @Override
    public Field<BigInteger> field7() {
        return X$USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$USER_SUMMARY_BY_STATEMENT_LATENCY.ROWS_EXAMINED;
    }

    @Override
    public Field<BigInteger> field8() {
        return X$USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$USER_SUMMARY_BY_STATEMENT_LATENCY.ROWS_AFFECTED;
    }

    @Override
    public Field<BigInteger> field9() {
        return X$USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$USER_SUMMARY_BY_STATEMENT_LATENCY.FULL_SCANS;
    }
    ...
    public X$userSummaryByStatementLatencyRecord() {
        super(X$USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.X$USER_SUMMARY_BY_STATEMENT_LATENCY);
    }
