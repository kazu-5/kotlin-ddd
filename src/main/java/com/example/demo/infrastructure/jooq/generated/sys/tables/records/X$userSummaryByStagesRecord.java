...
public class X$userSummaryByStagesRecord extends TableRecordImpl<X$userSummaryByStagesRecord> implements Record5<String, String, ULong, ULong, ULong> {
    ...
    private static final long serialVersionUID = 926203555;
    ...
    public Field<String> field1() {
        return X$USER_SUMMARY_BY_STAGES_TABLE.X$USER_SUMMARY_BY_STAGES.USER;
    }

    @Override
    public Field<String> field2() {
        return X$USER_SUMMARY_BY_STAGES_TABLE.X$USER_SUMMARY_BY_STAGES.EVENT_NAME;
    }

    @Override
    public Field<ULong> field3() {
        return X$USER_SUMMARY_BY_STAGES_TABLE.X$USER_SUMMARY_BY_STAGES.TOTAL;
    }

    @Override
    public Field<ULong> field4() {
        return X$USER_SUMMARY_BY_STAGES_TABLE.X$USER_SUMMARY_BY_STAGES.TOTAL_LATENCY;
    }

    @Override
    public Field<ULong> field5() {
        return X$USER_SUMMARY_BY_STAGES_TABLE.X$USER_SUMMARY_BY_STAGES.AVG_LATENCY;
    }
    ...
    public X$userSummaryByStagesRecord() {
        super(X$USER_SUMMARY_BY_STAGES_TABLE.X$USER_SUMMARY_BY_STAGES);
    }
