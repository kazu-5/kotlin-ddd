...
public class HostSummaryByFileIoTypeRecord extends TableRecordImpl<HostSummaryByFileIoTypeRecord> implements Record5<String, String, ULong, String, String> {
    ...
    private static final long serialVersionUID = 928477705;
    ...
    public Field<String> field1() {
        return HOST_SUMMARY_BY_FILE_IO_TYPE_TABLE.HOST_SUMMARY_BY_FILE_IO_TYPE.HOST;
    }

    @Override
    public Field<String> field2() {
        return HOST_SUMMARY_BY_FILE_IO_TYPE_TABLE.HOST_SUMMARY_BY_FILE_IO_TYPE.EVENT_NAME;
    }

    @Override
    public Field<ULong> field3() {
        return HOST_SUMMARY_BY_FILE_IO_TYPE_TABLE.HOST_SUMMARY_BY_FILE_IO_TYPE.TOTAL;
    }

    @Override
    public Field<String> field4() {
        return HOST_SUMMARY_BY_FILE_IO_TYPE_TABLE.HOST_SUMMARY_BY_FILE_IO_TYPE.TOTAL_LATENCY;
    }

    @Override
    public Field<String> field5() {
        return HOST_SUMMARY_BY_FILE_IO_TYPE_TABLE.HOST_SUMMARY_BY_FILE_IO_TYPE.MAX_LATENCY;
    }
    ...
    public HostSummaryByFileIoTypeRecord() {
        super(HOST_SUMMARY_BY_FILE_IO_TYPE_TABLE.HOST_SUMMARY_BY_FILE_IO_TYPE);
    }
