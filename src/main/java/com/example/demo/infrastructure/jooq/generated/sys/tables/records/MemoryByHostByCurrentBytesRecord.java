...
public class MemoryByHostByCurrentBytesRecord extends TableRecordImpl<MemoryByHostByCurrentBytesRecord> implements Record6<String, BigInteger, String, String, String, String> {
    ...
    private static final long serialVersionUID = 568863804;
    ...
    public Field<String> field1() {
        return MEMORY_BY_HOST_BY_CURRENT_BYTES_TABLE.MEMORY_BY_HOST_BY_CURRENT_BYTES.HOST;
    }

    @Override
    public Field<BigInteger> field2() {
        return MEMORY_BY_HOST_BY_CURRENT_BYTES_TABLE.MEMORY_BY_HOST_BY_CURRENT_BYTES.CURRENT_COUNT_USED;
    }

    @Override
    public Field<String> field3() {
        return MEMORY_BY_HOST_BY_CURRENT_BYTES_TABLE.MEMORY_BY_HOST_BY_CURRENT_BYTES.CURRENT_ALLOCATED;
    }

    @Override
    public Field<String> field4() {
        return MEMORY_BY_HOST_BY_CURRENT_BYTES_TABLE.MEMORY_BY_HOST_BY_CURRENT_BYTES.CURRENT_AVG_ALLOC;
    }

    @Override
    public Field<String> field5() {
        return MEMORY_BY_HOST_BY_CURRENT_BYTES_TABLE.MEMORY_BY_HOST_BY_CURRENT_BYTES.CURRENT_MAX_ALLOC;
    }

    @Override
    public Field<String> field6() {
        return MEMORY_BY_HOST_BY_CURRENT_BYTES_TABLE.MEMORY_BY_HOST_BY_CURRENT_BYTES.TOTAL_ALLOCATED;
    }
    ...
    public MemoryByHostByCurrentBytesRecord() {
        super(MEMORY_BY_HOST_BY_CURRENT_BYTES_TABLE.MEMORY_BY_HOST_BY_CURRENT_BYTES);
    }
