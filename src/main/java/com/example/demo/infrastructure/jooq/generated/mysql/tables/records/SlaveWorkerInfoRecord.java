...
public class SlaveWorkerInfoRecord extends UpdatableRecordImpl<SlaveWorkerInfoRecord> implements Record13<UInteger, String, ULong, String, ULong, String, ULong, String, ULong, UInteger, UInteger, byte[], String> {
    ...
    private static final long serialVersionUID = 783272977;
    ...
    public Field<UInteger> field1() {
        return SLAVE_WORKER_INFO_TABLE.SLAVE_WORKER_INFO.ID;
    }

    @Override
    public Field<String> field2() {
        return SLAVE_WORKER_INFO_TABLE.SLAVE_WORKER_INFO.RELAY_LOG_NAME;
    }

    @Override
    public Field<ULong> field3() {
        return SLAVE_WORKER_INFO_TABLE.SLAVE_WORKER_INFO.RELAY_LOG_POS;
    }

    @Override
    public Field<String> field4() {
        return SLAVE_WORKER_INFO_TABLE.SLAVE_WORKER_INFO.MASTER_LOG_NAME;
    }

    @Override
    public Field<ULong> field5() {
        return SLAVE_WORKER_INFO_TABLE.SLAVE_WORKER_INFO.MASTER_LOG_POS;
    }

    @Override
    public Field<String> field6() {
        return SLAVE_WORKER_INFO_TABLE.SLAVE_WORKER_INFO.CHECKPOINT_RELAY_LOG_NAME;
    }

    @Override
    public Field<ULong> field7() {
        return SLAVE_WORKER_INFO_TABLE.SLAVE_WORKER_INFO.CHECKPOINT_RELAY_LOG_POS;
    }

    @Override
    public Field<String> field8() {
        return SLAVE_WORKER_INFO_TABLE.SLAVE_WORKER_INFO.CHECKPOINT_MASTER_LOG_NAME;
    }

    @Override
    public Field<ULong> field9() {
        return SLAVE_WORKER_INFO_TABLE.SLAVE_WORKER_INFO.CHECKPOINT_MASTER_LOG_POS;
    }

    @Override
    public Field<UInteger> field10() {
        return SLAVE_WORKER_INFO_TABLE.SLAVE_WORKER_INFO.CHECKPOINT_SEQNO;
    }

    @Override
    public Field<UInteger> field11() {
        return SLAVE_WORKER_INFO_TABLE.SLAVE_WORKER_INFO.CHECKPOINT_GROUP_SIZE;
    }

    @Override
    public Field<byte[]> field12() {
        return SLAVE_WORKER_INFO_TABLE.SLAVE_WORKER_INFO.CHECKPOINT_GROUP_BITMAP;
    }

    @Override
    public Field<String> field13() {
        return SLAVE_WORKER_INFO_TABLE.SLAVE_WORKER_INFO.CHANNEL_NAME;
    }
    ...
    public SlaveWorkerInfoRecord() {
        super(SLAVE_WORKER_INFO_TABLE.SLAVE_WORKER_INFO);
    }
