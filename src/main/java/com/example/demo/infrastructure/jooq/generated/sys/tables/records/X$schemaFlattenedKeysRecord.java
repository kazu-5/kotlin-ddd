...
public class X$schemaFlattenedKeysRecord extends TableRecordImpl<X$schemaFlattenedKeysRecord> implements Record6<String, String, String, Long, Long, String> {
    ...
    private static final long serialVersionUID = -2094430503;
    ...
    public Field<String> field1() {
        return X$SCHEMA_FLATTENED_KEYS_TABLE.X$SCHEMA_FLATTENED_KEYS.TABLE_SCHEMA;
    }

    @Override
    public Field<String> field2() {
        return X$SCHEMA_FLATTENED_KEYS_TABLE.X$SCHEMA_FLATTENED_KEYS.TABLE_NAME;
    }

    @Override
    public Field<String> field3() {
        return X$SCHEMA_FLATTENED_KEYS_TABLE.X$SCHEMA_FLATTENED_KEYS.INDEX_NAME;
    }

    @Override
    public Field<Long> field4() {
        return X$SCHEMA_FLATTENED_KEYS_TABLE.X$SCHEMA_FLATTENED_KEYS.NON_UNIQUE;
    }

    @Override
    public Field<Long> field5() {
        return X$SCHEMA_FLATTENED_KEYS_TABLE.X$SCHEMA_FLATTENED_KEYS.SUBPART_EXISTS;
    }

    @Override
    public Field<String> field6() {
        return X$SCHEMA_FLATTENED_KEYS_TABLE.X$SCHEMA_FLATTENED_KEYS.INDEX_COLUMNS;
    }
    ...
    public X$schemaFlattenedKeysRecord() {
        super(X$SCHEMA_FLATTENED_KEYS_TABLE.X$SCHEMA_FLATTENED_KEYS);
    }
