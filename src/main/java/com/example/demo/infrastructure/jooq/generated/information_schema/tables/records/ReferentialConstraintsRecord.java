...
public class ReferentialConstraintsRecord extends TableRecordImpl<ReferentialConstraintsRecord> implements Record11<String, String, String, String, String, String, String, String, String, String, String> {
    ...
    private static final long serialVersionUID = 81071487;
    ...
    public Field<String> field1() {
        return REFERENTIAL_CONSTRAINTS_TABLE.REFERENTIAL_CONSTRAINTS.CONSTRAINT_CATALOG;
    }

    @Override
    public Field<String> field2() {
        return REFERENTIAL_CONSTRAINTS_TABLE.REFERENTIAL_CONSTRAINTS.CONSTRAINT_SCHEMA;
    }

    @Override
    public Field<String> field3() {
        return REFERENTIAL_CONSTRAINTS_TABLE.REFERENTIAL_CONSTRAINTS.CONSTRAINT_NAME;
    }

    @Override
    public Field<String> field4() {
        return REFERENTIAL_CONSTRAINTS_TABLE.REFERENTIAL_CONSTRAINTS.UNIQUE_CONSTRAINT_CATALOG;
    }

    @Override
    public Field<String> field5() {
        return REFERENTIAL_CONSTRAINTS_TABLE.REFERENTIAL_CONSTRAINTS.UNIQUE_CONSTRAINT_SCHEMA;
    }

    @Override
    public Field<String> field6() {
        return REFERENTIAL_CONSTRAINTS_TABLE.REFERENTIAL_CONSTRAINTS.UNIQUE_CONSTRAINT_NAME;
    }

    @Override
    public Field<String> field7() {
        return REFERENTIAL_CONSTRAINTS_TABLE.REFERENTIAL_CONSTRAINTS.MATCH_OPTION;
    }

    @Override
    public Field<String> field8() {
        return REFERENTIAL_CONSTRAINTS_TABLE.REFERENTIAL_CONSTRAINTS.UPDATE_RULE;
    }

    @Override
    public Field<String> field9() {
        return REFERENTIAL_CONSTRAINTS_TABLE.REFERENTIAL_CONSTRAINTS.DELETE_RULE;
    }

    @Override
    public Field<String> field10() {
        return REFERENTIAL_CONSTRAINTS_TABLE.REFERENTIAL_CONSTRAINTS.TABLE_NAME;
    }

    @Override
    public Field<String> field11() {
        return REFERENTIAL_CONSTRAINTS_TABLE.REFERENTIAL_CONSTRAINTS.REFERENCED_TABLE_NAME;
    }
    ...
    public ReferentialConstraintsRecord() {
        super(REFERENTIAL_CONSTRAINTS_TABLE.REFERENTIAL_CONSTRAINTS);
    }
