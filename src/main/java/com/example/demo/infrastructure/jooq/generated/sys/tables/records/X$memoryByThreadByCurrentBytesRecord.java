...
public class X$memoryByThreadByCurrentBytesRecord extends TableRecordImpl<X$memoryByThreadByCurrentBytesRecord> implements Record7<ULong, String, BigInteger, BigInteger, BigDecimal, Long, BigInteger> {
    ...
    private static final long serialVersionUID = -1078151128;
    ...
    public Field<ULong> field1() {
        return X$MEMORY_BY_THREAD_BY_CURRENT_BYTES_TABLE.X$MEMORY_BY_THREAD_BY_CURRENT_BYTES.THREAD_ID;
    }

    @Override
    public Field<String> field2() {
        return X$MEMORY_BY_THREAD_BY_CURRENT_BYTES_TABLE.X$MEMORY_BY_THREAD_BY_CURRENT_BYTES.USER;
    }

    @Override
    public Field<BigInteger> field3() {
        return X$MEMORY_BY_THREAD_BY_CURRENT_BYTES_TABLE.X$MEMORY_BY_THREAD_BY_CURRENT_BYTES.CURRENT_COUNT_USED;
    }

    @Override
    public Field<BigInteger> field4() {
        return X$MEMORY_BY_THREAD_BY_CURRENT_BYTES_TABLE.X$MEMORY_BY_THREAD_BY_CURRENT_BYTES.CURRENT_ALLOCATED;
    }

    @Override
    public Field<BigDecimal> field5() {
        return X$MEMORY_BY_THREAD_BY_CURRENT_BYTES_TABLE.X$MEMORY_BY_THREAD_BY_CURRENT_BYTES.CURRENT_AVG_ALLOC;
    }

    @Override
    public Field<Long> field6() {
        return X$MEMORY_BY_THREAD_BY_CURRENT_BYTES_TABLE.X$MEMORY_BY_THREAD_BY_CURRENT_BYTES.CURRENT_MAX_ALLOC;
    }

    @Override
    public Field<BigInteger> field7() {
        return X$MEMORY_BY_THREAD_BY_CURRENT_BYTES_TABLE.X$MEMORY_BY_THREAD_BY_CURRENT_BYTES.TOTAL_ALLOCATED;
    }
    ...
    public X$memoryByThreadByCurrentBytesRecord() {
        super(X$MEMORY_BY_THREAD_BY_CURRENT_BYTES_TABLE.X$MEMORY_BY_THREAD_BY_CURRENT_BYTES);
    }
