...
public class X$hostSummaryRecord extends TableRecordImpl<X$hostSummaryRecord> implements Record12<String, BigInteger, BigInteger, BigDecimal, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, Long, BigInteger, BigInteger> {
    ...
    private static final long serialVersionUID = -1640159451;
    ...
    public Field<String> field1() {
        return X$HOST_SUMMARY_TABLE.X$HOST_SUMMARY.HOST;
    }

    @Override
    public Field<BigInteger> field2() {
        return X$HOST_SUMMARY_TABLE.X$HOST_SUMMARY.STATEMENTS;
    }

    @Override
    public Field<BigInteger> field3() {
        return X$HOST_SUMMARY_TABLE.X$HOST_SUMMARY.STATEMENT_LATENCY;
    }

    @Override
    public Field<BigDecimal> field4() {
        return X$HOST_SUMMARY_TABLE.X$HOST_SUMMARY.STATEMENT_AVG_LATENCY;
    }

    @Override
    public Field<BigInteger> field5() {
        return X$HOST_SUMMARY_TABLE.X$HOST_SUMMARY.TABLE_SCANS;
    }

    @Override
    public Field<BigInteger> field6() {
        return X$HOST_SUMMARY_TABLE.X$HOST_SUMMARY.FILE_IOS;
    }

    @Override
    public Field<BigInteger> field7() {
        return X$HOST_SUMMARY_TABLE.X$HOST_SUMMARY.FILE_IO_LATENCY;
    }

    @Override
    public Field<BigInteger> field8() {
        return X$HOST_SUMMARY_TABLE.X$HOST_SUMMARY.CURRENT_CONNECTIONS;
    }

    @Override
    public Field<BigInteger> field9() {
        return X$HOST_SUMMARY_TABLE.X$HOST_SUMMARY.TOTAL_CONNECTIONS;
    }

    @Override
    public Field<Long> field10() {
        return X$HOST_SUMMARY_TABLE.X$HOST_SUMMARY.UNIQUE_USERS;
    }

    @Override
    public Field<BigInteger> field11() {
        return X$HOST_SUMMARY_TABLE.X$HOST_SUMMARY.CURRENT_MEMORY;
    }

    @Override
    public Field<BigInteger> field12() {
        return X$HOST_SUMMARY_TABLE.X$HOST_SUMMARY.TOTAL_MEMORY_ALLOCATED;
    }
    ...
    public X$hostSummaryRecord() {
        super(X$HOST_SUMMARY_TABLE.X$HOST_SUMMARY);
    }
