...
public class InnodbIndexStatsRecord extends UpdatableRecordImpl<InnodbIndexStatsRecord> implements Record8<String, String, String, Timestamp, String, ULong, ULong, String> {
    ...
    private static final long serialVersionUID = -998793641;
    ...
    public Field<String> field1() {
        return INNODB_INDEX_STATS_TABLE.INNODB_INDEX_STATS.DATABASE_NAME;
    }

    @Override
    public Field<String> field2() {
        return INNODB_INDEX_STATS_TABLE.INNODB_INDEX_STATS.TABLE_NAME;
    }

    @Override
    public Field<String> field3() {
        return INNODB_INDEX_STATS_TABLE.INNODB_INDEX_STATS.INDEX_NAME;
    }

    @Override
    public Field<Timestamp> field4() {
        return INNODB_INDEX_STATS_TABLE.INNODB_INDEX_STATS.LAST_UPDATE;
    }

    @Override
    public Field<String> field5() {
        return INNODB_INDEX_STATS_TABLE.INNODB_INDEX_STATS.STAT_NAME;
    }

    @Override
    public Field<ULong> field6() {
        return INNODB_INDEX_STATS_TABLE.INNODB_INDEX_STATS.STAT_VALUE;
    }

    @Override
    public Field<ULong> field7() {
        return INNODB_INDEX_STATS_TABLE.INNODB_INDEX_STATS.SAMPLE_SIZE;
    }

    @Override
    public Field<String> field8() {
        return INNODB_INDEX_STATS_TABLE.INNODB_INDEX_STATS.STAT_DESCRIPTION;
    }
    ...
    public InnodbIndexStatsRecord() {
        super(INNODB_INDEX_STATS_TABLE.INNODB_INDEX_STATS);
    }
