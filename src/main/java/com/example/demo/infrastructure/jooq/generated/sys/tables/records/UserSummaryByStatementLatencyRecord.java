...
public class UserSummaryByStatementLatencyRecord extends TableRecordImpl<UserSummaryByStatementLatencyRecord> implements Record9<String, BigInteger, String, String, String, BigInteger, BigInteger, BigInteger, BigInteger> {
    ...
    private static final long serialVersionUID = -144317861;
    ...
    public Field<String> field1() {
        return USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.USER_SUMMARY_BY_STATEMENT_LATENCY.USER;
    }

    @Override
    public Field<BigInteger> field2() {
        return USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.USER_SUMMARY_BY_STATEMENT_LATENCY.TOTAL;
    }

    @Override
    public Field<String> field3() {
        return USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.USER_SUMMARY_BY_STATEMENT_LATENCY.TOTAL_LATENCY;
    }

    @Override
    public Field<String> field4() {
        return USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.USER_SUMMARY_BY_STATEMENT_LATENCY.MAX_LATENCY;
    }

    @Override
    public Field<String> field5() {
        return USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.USER_SUMMARY_BY_STATEMENT_LATENCY.LOCK_LATENCY;
    }

    @Override
    public Field<BigInteger> field6() {
        return USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.USER_SUMMARY_BY_STATEMENT_LATENCY.ROWS_SENT;
    }

    @Override
    public Field<BigInteger> field7() {
        return USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.USER_SUMMARY_BY_STATEMENT_LATENCY.ROWS_EXAMINED;
    }

    @Override
    public Field<BigInteger> field8() {
        return USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.USER_SUMMARY_BY_STATEMENT_LATENCY.ROWS_AFFECTED;
    }

    @Override
    public Field<BigInteger> field9() {
        return USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.USER_SUMMARY_BY_STATEMENT_LATENCY.FULL_SCANS;
    }
    ...
    public UserSummaryByStatementLatencyRecord() {
        super(USER_SUMMARY_BY_STATEMENT_LATENCY_TABLE.USER_SUMMARY_BY_STATEMENT_LATENCY);
    }
