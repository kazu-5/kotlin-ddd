...
public class HelpTopicRecord extends UpdatableRecordImpl<HelpTopicRecord> implements Record6<UInteger, String, UShort, String, String, String> {
    ...
    private static final long serialVersionUID = 488633757;
    ...
    public Field<UInteger> field1() {
        return HELP_TOPIC_TABLE.HELP_TOPIC.HELP_TOPIC_ID;
    }

    @Override
    public Field<String> field2() {
        return HELP_TOPIC_TABLE.HELP_TOPIC.NAME;
    }

    @Override
    public Field<UShort> field3() {
        return HELP_TOPIC_TABLE.HELP_TOPIC.HELP_CATEGORY_ID;
    }

    @Override
    public Field<String> field4() {
        return HELP_TOPIC_TABLE.HELP_TOPIC.DESCRIPTION;
    }

    @Override
    public Field<String> field5() {
        return HELP_TOPIC_TABLE.HELP_TOPIC.EXAMPLE;
    }

    @Override
    public Field<String> field6() {
        return HELP_TOPIC_TABLE.HELP_TOPIC.URL;
    }
    ...
    public HelpTopicRecord() {
        super(HELP_TOPIC_TABLE.HELP_TOPIC);
    }
