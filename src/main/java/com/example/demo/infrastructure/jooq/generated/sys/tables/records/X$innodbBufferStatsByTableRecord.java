...
public class X$innodbBufferStatsByTableRecord extends TableRecordImpl<X$innodbBufferStatsByTableRecord> implements Record8<String, String, BigInteger, BigInteger, Long, Long, Long, BigInteger> {
    ...
    private static final long serialVersionUID = 1555994982;
    ...
    public Field<String> field1() {
        return X$INNODB_BUFFER_STATS_BY_TABLE_TABLE.X$INNODB_BUFFER_STATS_BY_TABLE.OBJECT_SCHEMA;
    }

    @Override
    public Field<String> field2() {
        return X$INNODB_BUFFER_STATS_BY_TABLE_TABLE.X$INNODB_BUFFER_STATS_BY_TABLE.OBJECT_NAME;
    }

    @Override
    public Field<BigInteger> field3() {
        return X$INNODB_BUFFER_STATS_BY_TABLE_TABLE.X$INNODB_BUFFER_STATS_BY_TABLE.ALLOCATED;
    }

    @Override
    public Field<BigInteger> field4() {
        return X$INNODB_BUFFER_STATS_BY_TABLE_TABLE.X$INNODB_BUFFER_STATS_BY_TABLE.DATA;
    }

    @Override
    public Field<Long> field5() {
        return X$INNODB_BUFFER_STATS_BY_TABLE_TABLE.X$INNODB_BUFFER_STATS_BY_TABLE.PAGES;
    }

    @Override
    public Field<Long> field6() {
        return X$INNODB_BUFFER_STATS_BY_TABLE_TABLE.X$INNODB_BUFFER_STATS_BY_TABLE.PAGES_HASHED;
    }

    @Override
    public Field<Long> field7() {
        return X$INNODB_BUFFER_STATS_BY_TABLE_TABLE.X$INNODB_BUFFER_STATS_BY_TABLE.PAGES_OLD;
    }

    @Override
    public Field<BigInteger> field8() {
        return X$INNODB_BUFFER_STATS_BY_TABLE_TABLE.X$INNODB_BUFFER_STATS_BY_TABLE.ROWS_CACHED;
    }
    ...
    public X$innodbBufferStatsByTableRecord() {
        super(X$INNODB_BUFFER_STATS_BY_TABLE_TABLE.X$INNODB_BUFFER_STATS_BY_TABLE);
    }
