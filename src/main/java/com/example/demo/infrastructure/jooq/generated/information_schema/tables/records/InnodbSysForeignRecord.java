...
public class InnodbSysForeignRecord extends TableRecordImpl<InnodbSysForeignRecord> implements Record5<String, String, String, UInteger, UInteger> {
    ...
    private static final long serialVersionUID = 648753844;
    ...
    public Field<String> field1() {
        return INNODB_SYS_FOREIGN_TABLE.INNODB_SYS_FOREIGN.ID;
    }

    @Override
    public Field<String> field2() {
        return INNODB_SYS_FOREIGN_TABLE.INNODB_SYS_FOREIGN.FOR_NAME;
    }

    @Override
    public Field<String> field3() {
        return INNODB_SYS_FOREIGN_TABLE.INNODB_SYS_FOREIGN.REF_NAME;
    }

    @Override
    public Field<UInteger> field4() {
        return INNODB_SYS_FOREIGN_TABLE.INNODB_SYS_FOREIGN.N_COLS;
    }

    @Override
    public Field<UInteger> field5() {
        return INNODB_SYS_FOREIGN_TABLE.INNODB_SYS_FOREIGN.TYPE;
    }
    ...
    public InnodbSysForeignRecord() {
        super(INNODB_SYS_FOREIGN_TABLE.INNODB_SYS_FOREIGN);
    }
