...
public class X$ioGlobalByFileByLatencyRecord extends TableRecordImpl<X$ioGlobalByFileByLatencyRecord> implements Record9<String, ULong, ULong, ULong, ULong, ULong, ULong, ULong, ULong> {
    ...
    private static final long serialVersionUID = 580773057;
    ...
    public Field<String> field1() {
        return X$IO_GLOBAL_BY_FILE_BY_LATENCY_TABLE.X$IO_GLOBAL_BY_FILE_BY_LATENCY.FILE;
    }

    @Override
    public Field<ULong> field2() {
        return X$IO_GLOBAL_BY_FILE_BY_LATENCY_TABLE.X$IO_GLOBAL_BY_FILE_BY_LATENCY.TOTAL;
    }

    @Override
    public Field<ULong> field3() {
        return X$IO_GLOBAL_BY_FILE_BY_LATENCY_TABLE.X$IO_GLOBAL_BY_FILE_BY_LATENCY.TOTAL_LATENCY;
    }

    @Override
    public Field<ULong> field4() {
        return X$IO_GLOBAL_BY_FILE_BY_LATENCY_TABLE.X$IO_GLOBAL_BY_FILE_BY_LATENCY.COUNT_READ;
    }

    @Override
    public Field<ULong> field5() {
        return X$IO_GLOBAL_BY_FILE_BY_LATENCY_TABLE.X$IO_GLOBAL_BY_FILE_BY_LATENCY.READ_LATENCY;
    }

    @Override
    public Field<ULong> field6() {
        return X$IO_GLOBAL_BY_FILE_BY_LATENCY_TABLE.X$IO_GLOBAL_BY_FILE_BY_LATENCY.COUNT_WRITE;
    }

    @Override
    public Field<ULong> field7() {
        return X$IO_GLOBAL_BY_FILE_BY_LATENCY_TABLE.X$IO_GLOBAL_BY_FILE_BY_LATENCY.WRITE_LATENCY;
    }

    @Override
    public Field<ULong> field8() {
        return X$IO_GLOBAL_BY_FILE_BY_LATENCY_TABLE.X$IO_GLOBAL_BY_FILE_BY_LATENCY.COUNT_MISC;
    }

    @Override
    public Field<ULong> field9() {
        return X$IO_GLOBAL_BY_FILE_BY_LATENCY_TABLE.X$IO_GLOBAL_BY_FILE_BY_LATENCY.MISC_LATENCY;
    }
    ...
    public X$ioGlobalByFileByLatencyRecord() {
        super(X$IO_GLOBAL_BY_FILE_BY_LATENCY_TABLE.X$IO_GLOBAL_BY_FILE_BY_LATENCY);
    }
