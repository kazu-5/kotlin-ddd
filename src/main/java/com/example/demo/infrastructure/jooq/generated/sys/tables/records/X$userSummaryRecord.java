...
public class X$userSummaryRecord extends TableRecordImpl<X$userSummaryRecord> implements Record12<String, BigInteger, BigInteger, BigDecimal, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, Long, BigInteger, BigInteger> {
    ...
    private static final long serialVersionUID = 1959508363;
    ...
    public Field<String> field1() {
        return X$USER_SUMMARY_TABLE.X$USER_SUMMARY.USER;
    }

    @Override
    public Field<BigInteger> field2() {
        return X$USER_SUMMARY_TABLE.X$USER_SUMMARY.STATEMENTS;
    }

    @Override
    public Field<BigInteger> field3() {
        return X$USER_SUMMARY_TABLE.X$USER_SUMMARY.STATEMENT_LATENCY;
    }

    @Override
    public Field<BigDecimal> field4() {
        return X$USER_SUMMARY_TABLE.X$USER_SUMMARY.STATEMENT_AVG_LATENCY;
    }

    @Override
    public Field<BigInteger> field5() {
        return X$USER_SUMMARY_TABLE.X$USER_SUMMARY.TABLE_SCANS;
    }

    @Override
    public Field<BigInteger> field6() {
        return X$USER_SUMMARY_TABLE.X$USER_SUMMARY.FILE_IOS;
    }

    @Override
    public Field<BigInteger> field7() {
        return X$USER_SUMMARY_TABLE.X$USER_SUMMARY.FILE_IO_LATENCY;
    }

    @Override
    public Field<BigInteger> field8() {
        return X$USER_SUMMARY_TABLE.X$USER_SUMMARY.CURRENT_CONNECTIONS;
    }

    @Override
    public Field<BigInteger> field9() {
        return X$USER_SUMMARY_TABLE.X$USER_SUMMARY.TOTAL_CONNECTIONS;
    }

    @Override
    public Field<Long> field10() {
        return X$USER_SUMMARY_TABLE.X$USER_SUMMARY.UNIQUE_HOSTS;
    }

    @Override
    public Field<BigInteger> field11() {
        return X$USER_SUMMARY_TABLE.X$USER_SUMMARY.CURRENT_MEMORY;
    }

    @Override
    public Field<BigInteger> field12() {
        return X$USER_SUMMARY_TABLE.X$USER_SUMMARY.TOTAL_MEMORY_ALLOCATED;
    }
    ...
    public X$userSummaryRecord() {
        super(X$USER_SUMMARY_TABLE.X$USER_SUMMARY);
    }
