...
import com.example.demo.infrastructure.jooq.generated.performance_schema.tables.records.GlobalVariablesRecord;
...
public class GLOBAL_VARIABLES_TABLE extends TableImpl<GlobalVariablesRecord> {
    ...
    private static final long serialVersionUID = -453491574;
     ...
     */
    public final TableField<GlobalVariablesRecord, String> VARIABLE_NAME = createField(DSL.name("VARIABLE_NAME"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
