...
public class X$schemaTableLockWaitsRecord extends TableRecordImpl<X$schemaTableLockWaitsRecord> implements Record18<String, String, ULong, ULong, String, String, String, String, Long, ULong, ULong, ULong, ULong, String, String, String, String, String> {
    ...
    private static final long serialVersionUID = 611442731;
    ...
    public Field<String> field1() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.OBJECT_SCHEMA;
    }

    @Override
    public Field<String> field2() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.OBJECT_NAME;
    }

    @Override
    public Field<ULong> field3() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.WAITING_THREAD_ID;
    }

    @Override
    public Field<ULong> field4() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.WAITING_PID;
    }

    @Override
    public Field<String> field5() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.WAITING_ACCOUNT;
    }

    @Override
    public Field<String> field6() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.WAITING_LOCK_TYPE;
    }

    @Override
    public Field<String> field7() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.WAITING_LOCK_DURATION;
    }

    @Override
    public Field<String> field8() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.WAITING_QUERY;
    }

    @Override
    public Field<Long> field9() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.WAITING_QUERY_SECS;
    }

    @Override
    public Field<ULong> field10() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.WAITING_QUERY_ROWS_AFFECTED;
    }

    @Override
    public Field<ULong> field11() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.WAITING_QUERY_ROWS_EXAMINED;
    }

    @Override
    public Field<ULong> field12() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.BLOCKING_THREAD_ID;
    }

    @Override
    public Field<ULong> field13() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.BLOCKING_PID;
    }

    @Override
    public Field<String> field14() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.BLOCKING_ACCOUNT;
    }

    @Override
    public Field<String> field15() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.BLOCKING_LOCK_TYPE;
    }

    @Override
    public Field<String> field16() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.BLOCKING_LOCK_DURATION;
    }

    @Override
    public Field<String> field17() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.SQL_KILL_BLOCKING_QUERY;
    }

    @Override
    public Field<String> field18() {
        return X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS.SQL_KILL_BLOCKING_CONNECTION;
    }
    ...
    public X$schemaTableLockWaitsRecord() {
        super(X$SCHEMA_TABLE_LOCK_WAITS_TABLE.X$SCHEMA_TABLE_LOCK_WAITS);
    }
