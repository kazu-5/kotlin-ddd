...
public class X$psDigestAvgLatencyDistributionRecord extends TableRecordImpl<X$psDigestAvgLatencyDistributionRecord> implements Record2<Long, BigInteger> {
    ...
    private static final long serialVersionUID = 164532012;
    ...
    public Field<Long> field1() {
        return X$PS_DIGEST_AVG_LATENCY_DISTRIBUTION_TABLE.X$PS_DIGEST_AVG_LATENCY_DISTRIBUTION.CNT;
    }

    @Override
    public Field<BigInteger> field2() {
        return X$PS_DIGEST_AVG_LATENCY_DISTRIBUTION_TABLE.X$PS_DIGEST_AVG_LATENCY_DISTRIBUTION.AVG_US;
    }
    ...
    public X$psDigestAvgLatencyDistributionRecord() {
        super(X$PS_DIGEST_AVG_LATENCY_DISTRIBUTION_TABLE.X$PS_DIGEST_AVG_LATENCY_DISTRIBUTION);
    }
