...
public class X$hostSummaryByFileIoRecord extends TableRecordImpl<X$hostSummaryByFileIoRecord> implements Record3<String, BigInteger, BigInteger> {
    ...
    private static final long serialVersionUID = -353518167;
    ...
    public Field<String> field1() {
        return X$HOST_SUMMARY_BY_FILE_IO_TABLE.X$HOST_SUMMARY_BY_FILE_IO.HOST;
    }

    @Override
    public Field<BigInteger> field2() {
        return X$HOST_SUMMARY_BY_FILE_IO_TABLE.X$HOST_SUMMARY_BY_FILE_IO.IOS;
    }

    @Override
    public Field<BigInteger> field3() {
        return X$HOST_SUMMARY_BY_FILE_IO_TABLE.X$HOST_SUMMARY_BY_FILE_IO.IO_LATENCY;
    }
    ...
    public X$hostSummaryByFileIoRecord() {
        super(X$HOST_SUMMARY_BY_FILE_IO_TABLE.X$HOST_SUMMARY_BY_FILE_IO);
    }
