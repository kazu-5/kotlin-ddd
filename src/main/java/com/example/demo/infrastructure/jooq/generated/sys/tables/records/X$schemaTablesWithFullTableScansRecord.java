...
public class X$schemaTablesWithFullTableScansRecord extends TableRecordImpl<X$schemaTablesWithFullTableScansRecord> implements Record4<String, String, ULong, ULong> {
    ...
    private static final long serialVersionUID = 1130598185;
    ...
    public Field<String> field1() {
        return X$SCHEMA_TABLES_WITH_FULL_TABLE_SCANS_TABLE.X$SCHEMA_TABLES_WITH_FULL_TABLE_SCANS.OBJECT_SCHEMA;
    }

    @Override
    public Field<String> field2() {
        return X$SCHEMA_TABLES_WITH_FULL_TABLE_SCANS_TABLE.X$SCHEMA_TABLES_WITH_FULL_TABLE_SCANS.OBJECT_NAME;
    }

    @Override
    public Field<ULong> field3() {
        return X$SCHEMA_TABLES_WITH_FULL_TABLE_SCANS_TABLE.X$SCHEMA_TABLES_WITH_FULL_TABLE_SCANS.ROWS_FULL_SCANNED;
    }

    @Override
    public Field<ULong> field4() {
        return X$SCHEMA_TABLES_WITH_FULL_TABLE_SCANS_TABLE.X$SCHEMA_TABLES_WITH_FULL_TABLE_SCANS.LATENCY;
    }
    ...
    public X$schemaTablesWithFullTableScansRecord() {
        super(X$SCHEMA_TABLES_WITH_FULL_TABLE_SCANS_TABLE.X$SCHEMA_TABLES_WITH_FULL_TABLE_SCANS);
    }
