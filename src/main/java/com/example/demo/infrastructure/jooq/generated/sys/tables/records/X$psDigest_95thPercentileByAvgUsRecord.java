...
public class X$psDigest_95thPercentileByAvgUsRecord extends TableRecordImpl<X$psDigest_95thPercentileByAvgUsRecord> implements Record2<BigInteger, BigDecimal> {
    ...
    private static final long serialVersionUID = 187910496;
    ...
    public Field<BigInteger> field1() {
        return X$PS_DIGEST_95TH_PERCENTILE_BY_AVG_US_TABLE.X$PS_DIGEST_95TH_PERCENTILE_BY_AVG_US.AVG_US;
    }

    @Override
    public Field<BigDecimal> field2() {
        return X$PS_DIGEST_95TH_PERCENTILE_BY_AVG_US_TABLE.X$PS_DIGEST_95TH_PERCENTILE_BY_AVG_US.PERCENTILE;
    }
    ...
    public X$psDigest_95thPercentileByAvgUsRecord() {
        super(X$PS_DIGEST_95TH_PERCENTILE_BY_AVG_US_TABLE.X$PS_DIGEST_95TH_PERCENTILE_BY_AVG_US);
    }
