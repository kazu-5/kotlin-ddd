...
public class X$memoryByUserByCurrentBytesRecord extends TableRecordImpl<X$memoryByUserByCurrentBytesRecord> implements Record6<String, BigInteger, BigInteger, BigDecimal, Long, BigInteger> {
    ...
    private static final long serialVersionUID = -525448757;
    ...
    public Field<String> field1() {
        return X$MEMORY_BY_USER_BY_CURRENT_BYTES_TABLE.X$MEMORY_BY_USER_BY_CURRENT_BYTES.USER;
    }

    @Override
    public Field<BigInteger> field2() {
        return X$MEMORY_BY_USER_BY_CURRENT_BYTES_TABLE.X$MEMORY_BY_USER_BY_CURRENT_BYTES.CURRENT_COUNT_USED;
    }

    @Override
    public Field<BigInteger> field3() {
        return X$MEMORY_BY_USER_BY_CURRENT_BYTES_TABLE.X$MEMORY_BY_USER_BY_CURRENT_BYTES.CURRENT_ALLOCATED;
    }

    @Override
    public Field<BigDecimal> field4() {
        return X$MEMORY_BY_USER_BY_CURRENT_BYTES_TABLE.X$MEMORY_BY_USER_BY_CURRENT_BYTES.CURRENT_AVG_ALLOC;
    }

    @Override
    public Field<Long> field5() {
        return X$MEMORY_BY_USER_BY_CURRENT_BYTES_TABLE.X$MEMORY_BY_USER_BY_CURRENT_BYTES.CURRENT_MAX_ALLOC;
    }

    @Override
    public Field<BigInteger> field6() {
        return X$MEMORY_BY_USER_BY_CURRENT_BYTES_TABLE.X$MEMORY_BY_USER_BY_CURRENT_BYTES.TOTAL_ALLOCATED;
    }
    ...
    public X$memoryByUserByCurrentBytesRecord() {
        super(X$MEMORY_BY_USER_BY_CURRENT_BYTES_TABLE.X$MEMORY_BY_USER_BY_CURRENT_BYTES);
    }
