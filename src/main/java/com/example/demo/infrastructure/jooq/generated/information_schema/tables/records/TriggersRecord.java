...
public class TriggersRecord extends TableRecordImpl<TriggersRecord> implements Record22<String, String, String, String, String, String, String, Long, String, String, String, String, String, String, String, String, Timestamp, String, String, String, String, String> {
    ...
    private static final long serialVersionUID = -1614481567;
    ...
    public Field<String> field1() {
        return TRIGGERS_TABLE.TRIGGERS.TRIGGER_CATALOG;
    }

    @Override
    public Field<String> field2() {
        return TRIGGERS_TABLE.TRIGGERS.TRIGGER_SCHEMA;
    }

    @Override
    public Field<String> field3() {
        return TRIGGERS_TABLE.TRIGGERS.TRIGGER_NAME;
    }

    @Override
    public Field<String> field4() {
        return TRIGGERS_TABLE.TRIGGERS.EVENT_MANIPULATION;
    }

    @Override
    public Field<String> field5() {
        return TRIGGERS_TABLE.TRIGGERS.EVENT_OBJECT_CATALOG;
    }

    @Override
    public Field<String> field6() {
        return TRIGGERS_TABLE.TRIGGERS.EVENT_OBJECT_SCHEMA;
    }

    @Override
    public Field<String> field7() {
        return TRIGGERS_TABLE.TRIGGERS.EVENT_OBJECT_TABLE;
    }

    @Override
    public Field<Long> field8() {
        return TRIGGERS_TABLE.TRIGGERS.ACTION_ORDER;
    }

    @Override
    public Field<String> field9() {
        return TRIGGERS_TABLE.TRIGGERS.ACTION_CONDITION;
    }

    @Override
    public Field<String> field10() {
        return TRIGGERS_TABLE.TRIGGERS.ACTION_STATEMENT;
    }

    @Override
    public Field<String> field11() {
        return TRIGGERS_TABLE.TRIGGERS.ACTION_ORIENTATION;
    }

    @Override
    public Field<String> field12() {
        return TRIGGERS_TABLE.TRIGGERS.ACTION_TIMING;
    }

    @Override
    public Field<String> field13() {
        return TRIGGERS_TABLE.TRIGGERS.ACTION_REFERENCE_OLD_TABLE;
    }

    @Override
    public Field<String> field14() {
        return TRIGGERS_TABLE.TRIGGERS.ACTION_REFERENCE_NEW_TABLE;
    }

    @Override
    public Field<String> field15() {
        return TRIGGERS_TABLE.TRIGGERS.ACTION_REFERENCE_OLD_ROW;
    }

    @Override
    public Field<String> field16() {
        return TRIGGERS_TABLE.TRIGGERS.ACTION_REFERENCE_NEW_ROW;
    }

    @Override
    public Field<Timestamp> field17() {
        return TRIGGERS_TABLE.TRIGGERS.CREATED;
    }

    @Override
    public Field<String> field18() {
        return TRIGGERS_TABLE.TRIGGERS.SQL_MODE;
    }

    @Override
    public Field<String> field19() {
        return TRIGGERS_TABLE.TRIGGERS.DEFINER;
    }

    @Override
    public Field<String> field20() {
        return TRIGGERS_TABLE.TRIGGERS.CHARACTER_SET_CLIENT;
    }

    @Override
    public Field<String> field21() {
        return TRIGGERS_TABLE.TRIGGERS.COLLATION_CONNECTION;
    }

    @Override
    public Field<String> field22() {
        return TRIGGERS_TABLE.TRIGGERS.DATABASE_COLLATION;
    }
