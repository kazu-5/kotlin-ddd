...
public class X$memoryGlobalByCurrentBytesRecord extends TableRecordImpl<X$memoryGlobalByCurrentBytesRecord> implements Record7<String, Long, Long, BigDecimal, Long, Long, BigDecimal> {
    ...
    private static final long serialVersionUID = -658358136;
    ...
    public Field<String> field1() {
        return X$MEMORY_GLOBAL_BY_CURRENT_BYTES_TABLE.X$MEMORY_GLOBAL_BY_CURRENT_BYTES.EVENT_NAME;
    }

    @Override
    public Field<Long> field2() {
        return X$MEMORY_GLOBAL_BY_CURRENT_BYTES_TABLE.X$MEMORY_GLOBAL_BY_CURRENT_BYTES.CURRENT_COUNT;
    }

    @Override
    public Field<Long> field3() {
        return X$MEMORY_GLOBAL_BY_CURRENT_BYTES_TABLE.X$MEMORY_GLOBAL_BY_CURRENT_BYTES.CURRENT_ALLOC;
    }

    @Override
    public Field<BigDecimal> field4() {
        return X$MEMORY_GLOBAL_BY_CURRENT_BYTES_TABLE.X$MEMORY_GLOBAL_BY_CURRENT_BYTES.CURRENT_AVG_ALLOC;
    }

    @Override
    public Field<Long> field5() {
        return X$MEMORY_GLOBAL_BY_CURRENT_BYTES_TABLE.X$MEMORY_GLOBAL_BY_CURRENT_BYTES.HIGH_COUNT;
    }

    @Override
    public Field<Long> field6() {
        return X$MEMORY_GLOBAL_BY_CURRENT_BYTES_TABLE.X$MEMORY_GLOBAL_BY_CURRENT_BYTES.HIGH_ALLOC;
    }

    @Override
    public Field<BigDecimal> field7() {
        return X$MEMORY_GLOBAL_BY_CURRENT_BYTES_TABLE.X$MEMORY_GLOBAL_BY_CURRENT_BYTES.HIGH_AVG_ALLOC;
    }
    ...
    public X$memoryGlobalByCurrentBytesRecord() {
        super(X$MEMORY_GLOBAL_BY_CURRENT_BYTES_TABLE.X$MEMORY_GLOBAL_BY_CURRENT_BYTES);
    }
